    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="text-center">
                <h1><fmt:message key="administrator.bicycle_creation"/></h1>
            </div>
            <form method="post" action="${absolutePath}/controller" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" maxlength="20" name="model" class="form-control form-control-sm">
                </div>
