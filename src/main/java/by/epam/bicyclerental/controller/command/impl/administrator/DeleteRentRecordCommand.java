...
public class DeleteRentRecordCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        long rentalRecordId = Integer.parseInt(request.getParameter(RENT_RECORD_ID));
        try {
            rentRecordService.deleteRentRecord(rentalRecordId);
