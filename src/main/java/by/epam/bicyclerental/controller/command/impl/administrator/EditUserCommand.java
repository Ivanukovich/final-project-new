...
public class EditUserCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        formData.put(LOGIN, request.getParameter(LOGIN));
        ...
        try {
            ...
            if (userService.editUser(userId, formData)) {
                List<User> listUsers = userService.findAllUsers();
                request.setAttribute(USER_LIST, listUsers);
                router = new Router(PagePath.USER_LIST_PAGE, Router.RouterType.FORWARD);
            } else {
                ...
                router = new Router(PagePath.USER_EDIT_PAGE, Router.RouterType.FORWARD);
            }
            return router;
        }
